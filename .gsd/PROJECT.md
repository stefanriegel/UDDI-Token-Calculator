...
- [x] M001: MVP (Phases 1-8) — Single-binary Go tool with embedded React UI, AWS/Azure/GCP/AD scanning, token calculation, Excel export
- [x] M002: NIOS Grid Integration + Frontend Overhaul (Phases 9-14) — NIOS backup/WAPI, Bluecat, EfficientIP, Migration Planner, Server Token Calculator
- [x] M003: Auth Method Completion — All 9 backend auth methods implemented (AWS profile/assume-role, Azure CLI/cert/device-code, AD Kerberos/HTTPS, GCP browser-oauth/WIF)
- [x] M004-2qci81: Enterprise-Scale Cloud Scanning — Multi-account AWS/Azure/GCP, retry/backoff, checkpoint/resume, DNS per-type breakdown, 27 new resource scanners
- [ ] M005-93txzf: AD→NIOS-X Migration Sizing & Multi-Forest Support — Per-server NIOS-X tier calculation, migration planner for AD, multi-forest credentials, Knowledge Workers, Entra ID enrichment

---
*Last updated: 2026-03-18 after queuing M005-93txzf (AD→NIOS-X Migration Sizing & Multi-Forest Support)*
