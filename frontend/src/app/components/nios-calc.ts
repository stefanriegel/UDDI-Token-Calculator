...
export const MOCK_NIOS_SERVER_METRICS: NiosServerMetrics[] = [
  ...
  { memberId: 'combo-06', memberName: 'combo-latam-01.corp.example.com', role: 'DNS/DHCP', qps: 5400, lps: 55, objectCount: 2150, activeIPCount: 1100, model: 'IB-V815', platform: 'VMware', managedIPCount: 1500, staticHosts: 250, dynamicHosts: 850, dhcpUtilization: 773, licenses: { dns: true, dhcp: true } },
  // IPAM (4)
  ...
  { memberId: 'ipam-04', memberName: 'ipam-04.corp.example.com', role: 'IPAM', qps: 0, lps: 0, objectCount: 88, activeIPCount: 0, model: 'IB-V815', platform: 'VMware', managedIPCount: 0, staticHosts: 0, dynamicHosts: 0, dhcpUtilization: 0 },
  ...
  { memberId: 'rpt-03', memberName: 'reporting-central-01.corp.example.com', role: 'Reporting', qps: 0, lps: 0, objectCount: 520, activeIPCount: 0, model: 'IB-V815', platform: 'VMware', managedIPCount: 0, staticHosts: 0, dynamicHosts: 0, dhcpUtilization: 0 },
  { memberId: 'rpt-04', memberName: 'reporting-eu-01.corp.example.com', role: 'Reporting', qps: 0, lps: 0, objectCount: 290, activeIPCount: 0, model: 'IB-V815', platform: 'VMware', managedIPCount: 0, staticHosts: 0, dynamicHosts: 0, dhcpUtilization: 0 },
];
